...
function renderInterview() {
  ...
  for (let interview of interviewList) {
    ...
    div.classList = `card flex justify-between shadow rounded-lg p-3 md:p-8 bg-white`;
    div.innerHTML = `
      <div class="space-y-6">
                ...
                <div class="mt-1.5">
                    <div class="delete-btn cursor-pointer rounded-full border border-gray-300 p-2 md:p-4 shadow">
                        <svg class="object-cover" width="12" height="13" viewBox="0 0 12 13" fill="none"
